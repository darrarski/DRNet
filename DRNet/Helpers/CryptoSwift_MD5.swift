...
//  Pods
//
//  Created by Dariusz Rybicki on 10/02/15.
//

import Foundation

internal func CryptoSwift_MD5Hash(data: NSData) -> String {
    return MD5(data).calculate().toHexString()
}

//
//  ACKNOWLEDGE:
//  Code below is a part of CryptoSwift library by Marcin Krzyzanowski
//  https://github.com/krzyzanowskim/CryptoSwift
//
//
//  Copyright (C) 2014 Marcin Krzyżanowski marcin.krzyzanowski@gmail.com This software is provided 'as-is', 
//  without any express or implied warranty. In no event will the authors be held liable for any damages 
//  arising from the use of this software. Permission is granted to anyone to use this software for any 
//  purpose,including commercial applications, and to alter it and redistribute it freely, subject to the 
//  following restrictions:
//  * The origin of this software must not be misrepresented; you must not claim that you wrote the original 
//    software. If you use this software in a product, an acknowledgment in the product documentation is 
//    required.
...
private extension Int {
    ...
    func bytes(_ totalBytes: Int = sizeof(Int)) -> [Byte] {
...
private func arrayOfBytes<T>(value:T, length:Int? = nil) -> [Byte] {
